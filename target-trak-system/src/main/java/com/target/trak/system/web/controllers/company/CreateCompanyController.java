...
public class CreateCompanyController {
	...
	@RequestMapping(value = "/company/createCompany.json", method = RequestMethod.POST, produces = "application/json")
	public @ResponseBody Map<String, Object> searchCompanies(
		...
		request.setCompany(buildCompanyDto(name, addressLine1, addressLine2, city, state, zipcode, country));
		CompanyApiResponse response = service.executeRequest(request);
		jsonResponse.put("success", response.isSuccess());
		return jsonResponse;
	}
	
	private CompanyDto buildCompanyDto(final String name, String addressLine1, String addressLine2, String city, String state, String zipcode, String country) {

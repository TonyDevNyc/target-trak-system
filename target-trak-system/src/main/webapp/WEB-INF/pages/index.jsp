...
<html lang="en"
	<head>
	    ...
	    <script type="text/javascript" src="/target-trak-system/app.js"></script>
	    <link rel="stylesheet" type="text/css" href="/target-trak-system/resources/messagebox/example.css">
		<script type="text/javascript" src="/target-trak-system/resources/messagebox/examples.js"></script>
	</head>
	<body>
		<!-- <div id="loading-parent">
	  		<div id="loading-child">
		      <br/><br/>
		      <div id="loading-indicator">Loading Target-Trak.  Please wait...</div>
		  	</div>
		</div> -->
	</body>
</html>
